(function ($) {
  ...
  if ($("#traffic-chart2").length) {
    const ctx = document.getElementById('traffic-chart2');

    var graphGradient1 = document.getElementById("traffic-chart2").getContext('2d');
    var graphGradient2 = document.getElementById("traffic-chart2").getContext('2d');
    var graphGradient3 = document.getElementById("traffic-chart2").getContext('2d');
